...
#SBATCH --output=sentieon_HG002_2.0_%j.log
...
sentieon-cli sentieon-pangenome \
  ...
  --hapl /private/groups/cgl/hprc-graphs/hprc-v2.0-feb28/hprc-v2.0-mc-grch38/hprc-v2.0-mc-grch38.hapl \
  ...
  --pcr_free \
  -t 32 \
  results/HG002_pangenome_2.0.vcf.gz
